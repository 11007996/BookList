    ...
    static void ThrowException(string exceptionType)
    {
      ...
      switch (exceptionType)
      {
        case "none":
          ...
          break;
        case "simple":
          Console.WriteLine("ThrowException System.Exception.");
          throw new System.Exception();
        case "index":
          Console.WriteLine("ThrowException System.IndexOutOfRangException.");
          eTypes[5] = "error";
          break;
        case "nested index":
          try
        ...
        case "filter":
          try
          {
            Console.WriteLine("ThrowException(\"filter\")" + "try block rached.");
            Console.WriteLine("ThrowException(\"index\") called.");
            ThrowException("index");
          }
          catch
